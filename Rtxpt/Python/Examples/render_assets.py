...
Usage:
    ...
    # FPS benchmark test:
    python ../Rtxpt/Python/Examples/launch_default_scene.py --fps-test --fps-frames 200
    python ../Rtxpt/Python/Examples/launch_default_scene.py --fps-test --fps-frames 200 --obj-test

    # FPS benchmark with frame saving:
    python ../Rtxpt/Python/Examples/launch_default_scene.py --fps-test --fps-frames 100 --fps-save-frames --fps-output-dir ./test
"""
...
def main() -> int:
    ...
    if args.fps_test and not args.headless:
        print("[rtxpt] --fps-test requires headless mode; enabling --headless")
        args.headless = True
    launch_cwd = Path.cwd()
    ...
    if args.scene is not None:
        ...
        print(f"[rtxpt] Loading scene from: {scene_path}")
    ...
    try:
        ...
        if args.fps_test:
            print(f"[rtxpt] Running FPS benchmark ({args.fps_frames} frames, {args.fps_warmup} warmup)...")
