# --------------------------------------------------------------------
# RTXPT Python scripting - basic example
# --------------------------------------------------------------------
...
#
# Available globals:
#   * rtxpt.app()      -> the Sample renderer singleton
#   * rtxpt.settings() -> shortcut for rtxpt.app().settings
#
# Use rtxpt.log_info / log_warning / log_error to print to the host log.
# --------------------------------------------------------------------

import rtxpt

app = rtxpt.app()
settings = rtxpt.settings()

rtxpt.log_info(f"Loaded scene: {app.scene_name}")

# 1) List every material -- print a summary
print("\n=== Materials ===")
for mat in app.get_materials():
...
rtxpt.log_info("Python customization done.")
